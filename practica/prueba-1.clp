(definstances juego
		...
		(of HACEMAL (personalidad tramposo) (accion seMueveDeMas) (num-veces 0) (num-veces-max 2))
		(of CORRIGE (jugador niño) (accion seMueveDeMas) (respuesta UyQueTeHePillado))
		(of HACEMAL (personalidad tramposo) (accion seSaltaTurno) (num-veces 0) (num-veces-max 2))
		(of CORRIGE (jugador niño) (accion seSaltaTurno) (respuesta UyQueTeHePillado))
